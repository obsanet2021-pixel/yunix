...
CREATE INDEX IF NOT EXISTS idx_telegram_otp_expires ON public.telegram_otp(expires_at);

-- Enable RLS
ALTER TABLE IF EXISTS public.telegram_otp ENABLE ROW LEVEL SECURITY;
